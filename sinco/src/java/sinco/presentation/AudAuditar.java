...
public class AudAuditar implements HttpPresentation {
    private AudAuditarHTML pagHTML;
    ...
    public void run(HttpPresentationComms comms) throws HttpPresentationException, KeywordValueException {
        if (!comms.session.getSessionData().containsKey("miId")) {
            ...
            this.pagHTML = (AudAuditarHTML)comms.xmlcFactory.create(AudAuditarHTML.class);
            this.permisos(comms);
    ...
    private void creacion(HttpPresentationComms comms) throws HttpPresentationException, KeywordValueException {
        ...
        new RespuestaBD();
        RespuestaBD rta = ob.salvarRespuestas(ciclo, codigoProceso, preguntas, elUsuario);
        if (!rta.isRta()) {
            ...
            String sPagina = "AudAuditar.po?_operacion=V&ciclo=" + ciclo + "&codigoProceso=" + codigoProceso + "";
    ...
    private void listar(HttpPresentationComms comms, String _operacion) throws HttpPresentationException, KeywordValueException {
        ...
        if (!_operacion.equals("X")) {
            ...
            Collection<AudProcesosPlanAnualDTO> arr = ob.cargarTodos(ciclo, "");
            ...
            for(Iterator iterator = arr.iterator(); iterator.hasNext(); ++cuantas) {
                ...
                String url = "AudAuditar.po?_operacion=V&ciclo=" + reg.getCiclo() + "&codigoProceso=" + reg.getCodigoProceso() + "";
                eltr.appendChild(this.newtdhref("" + reg.getNombreCodigoProceso(), url));
                eltr.appendChild(this.newtd("" + reg.getNombreTipoAuditoria()));
                eltr.appendChild(this.newtd("" + reg.getNombrecoordinadorAuditoria()));
    ...
    private void verRegistro(int ciclo, String codigoProceso) {
        ...
        if (reg != null) {
            ...
            this.pagHTML.setTextCoordinadorAuditoríaEd("" + reg.getNombrecoordinadorAuditoria());
